      ...
      <div className="flex justify-center items-center gap-5">
        ...
        <div>
          <div className="dropdown dropdown-bottom dropdown-end ">
            ...
            >
              <li >
                <a onClick={logout} className="text-black flex justify-around "><p className="text-lg font-medium">Logout</p> <FontAwesomeIcon icon={faSignOutAlt} className="text-lg " /></a>
              </li>
            </ul>
          </div>
          {/*  */}
